...
const translations: Record<string, Record<Language, string>> = {
  ...
  "hero.role": { 
    EN: "Energy Engineer with hands-on experience in electrical distribution and renewable systems, currently specializing in Business Analytics and Applied AI.\n\nFocused on transforming data into operational improvements, automation, and smarter energy decisions.", 
    ES: "Ingeniero Energético con experiencia práctica en distribución eléctrica y sistemas de energías renovables, actualmente especializado en Business Analytics e Inteligencia Artificial Aplicada.\n\nEnfocado en transformar datos en mejoras operativas, automatización y decisiones energéticas más eficientes." 
  },
