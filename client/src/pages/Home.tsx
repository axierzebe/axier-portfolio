        ...
        <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-sm md:text-base text-muted-foreground mb-8 max-w-lg leading-relaxed whitespace-pre-line">
                {t("hero.role")}
              </p>
...
<Section id="about" className="bg-muted/30 rounded-3xl my-12 py-16">
  ...
  <div className="grid md:grid-cols-3 gap-12 items-start">
    <div className="md:col-span-2 text-lg leading-relaxed text-muted-foreground">
      <p>{t("about.bio")}</p>
        ...
        <div className="grid grid-cols-2 gap-6 mt-8">
          ...
          <div className="flex flex-col gap-2 p-4 bg-background rounded-xl border border-border/50 shadow-sm hover:border-secondary/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 active:translate-y-[-4px] active:shadow-lg cursor-pointer">
    ...
    <Card className="bg-background/50 backdrop-blur-sm border-primary/10 shadow-lg hover:border-primary/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 active:translate-y-[-4px] active:shadow-xl cursor-pointer">
...
<Section id="experience" className="py-16">
  ...
  <div className="relative border-l-2 border-primary/20 ml-4 md:ml-0 md:pl-8 space-y-12">
    <div className="relative">
      ...
      <Card className="border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 active:translate-y-[-4px] active:shadow-lg cursor-pointer">
        <CardHeader className="relative">
          ...
          <div className="hidden md:flex absolute top-4 right-4 flex-col items-end gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs font-medium px-2 py-1 rounded-md border border-border bg-background/80 hover:bg-primary/10 hover:text-primary hover:border-primary/30 transition-all duration-300 text-foreground"
            >
              PDF-ES
            </a>
          </div>
          ...
          <div className="flex flex-col gap-2 mt-6">
            ...
            <div className="flex flex-col items-start gap-2 md:hidden mt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-fit text-xs font-medium px-2 py-1 rounded-md border border-border bg-background/80 hover:bg-primary/10 hover:text-primary hover:border-primary/30 transition-all duration-300 text-foreground"
              >
                PDF-ES
              </a>
            </div>
  ...
  <div className="grid gap-6 max-w-4xl mx-auto">
    ...
    >
      ...
      >
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground italic border-l-2 pl-4 border-border group-hover:border-primary/40 transition-colors whitespace-pre-line">
            {t("edu.1.note")}
          </p>
        </CardContent>
      </Card>
    ...
    >
      ...
      >
        ...
        <Section id="contact" className="mb-12 py-16">
          ...
          <div className="max-w-xl mx-auto bg-card rounded-2xl p-8 shadow-xl border border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 active:translate-y-[-4px] active:shadow-xl cursor-pointer">
            <ContactForm />
          </div>
        </Section>
      </main>
...
function SkillCard({ title, icon, skills }: { title: string, icon: React.ReactNode, skills: string[] }) {
  return (
    <Card className="h-full border-border/50 bg-background/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 active:translate-y-[-4px] active:shadow-xl cursor-pointer">
